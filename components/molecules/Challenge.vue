<template>
	...
	<section class="flex flex-col flex-1 justify-center items-center py-6 px-10 md:px-16">
		...
		<footer class="flex w-full gap-x-2">
			...
			<button class="button success" @click="challengeSuccess " >Completed</button>
		</footer>
...
import { 
	...
	Challenge as ChallengesTypes,
} from '~/store/Challenges/types';

export default Vue.extend<unknown, any, unknown, ChallengesTypes>({
	props: {
